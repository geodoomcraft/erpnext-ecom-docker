...
docker buildx build \
  ...
  --cache-from=type=registry,ref=docker.io/geodoomcraft/erpnext-ecom-buildcache:buildcache \
  --cache-to=type=registry,ref=docker.io/geodoomcraft/erpnext-ecom-buildcache:buildcache,mode=max \
